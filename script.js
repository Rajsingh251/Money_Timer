document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateTimersFromAPI() {
        fetch('http://51.20.130.223/points_info')
    ...
    function startTimer() {
        fetch('http://51.20.130.223/start_timer', {
            method: 'POST'
        })
        .then(response => response.json())
        .then(() => {
    ...
    function stopTimer() {
        fetch('http://51.20.130.223/stop_timer', {
            method: 'POST'
        })
        .then(response => response.json())
        .then(() => {
    ...
    function resetTimer() {
        fetch('http://51.20.130.223/reset_timer', {
            method: 'POST'
        })
        .then(response => response.json())
        .then(() => {
    ...
    function addPoints(amount) {
        fetch('http://51.20.130.223/add_points', {
            method: 'POST',
            headers: {
